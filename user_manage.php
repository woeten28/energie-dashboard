...
$stmt = $pdo->prepare("SELECT * FROM energy_data WHERE username = :username ORDER BY date DESC");
...
<div class="container">
    <h2 class="center">Beheer van Energiegegevens (<?= htmlspecialchars($_SESSION['username']) ?>)</h2>
        ...
        <tbody>
            <?php while ($row = $stmt->fetch()): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_energy_user.php?id=<?= $row['entry_id'] ?>">Bewerken</a> |
